...
<template>
  <ContentNavigation v-slot="{ navigation }">
    <ul class=" flex flex-col gap-2  h-full mt-4  p-4 lg:p-0" :class="{ 'items-start': orientation === 'left', 'items-end text-right': orientation === 'right' }">
      <li v-for="link of navigation" :key="link._path" class="cursor-pointer ">
        ...
        <div v-else class="flex flex-col">
          ...
          <ul class="  left-0 py-2 whitespace-nowrap">
