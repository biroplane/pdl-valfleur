...
<template>
  <div class="relative">
    <div class="flex items-center border-white/50 bg-white/0 transition-colors border-b h-10 text-white focus-within:border-neutral-300 focus-within:bg-neutral-100/20 relative">
